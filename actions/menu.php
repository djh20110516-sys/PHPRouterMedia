...
<div class='menuBoxContainer'>
    <div class='menuBoxMS'>
        <div class='dRowMS tCenter'>
            <div class='listMenuElementMS'>
                <a onclick='menus_ms_show();' class='pointer'><img src="imgs/logo/3.png" class="imgLogo" title="PHPRouterMedia Logo" />PHPRouterMedia &#9776;<?php echo get_msg( 'MENU_HOME_MS',  FALSE ); ?></a>
            </div>
        </div>
    </div>
    ...
    <div class='menuBox'>
        ...
        <div class='dRow'>
            ...
            <div class='listMenuElementAdmin'>
                <a href='?action=importfolder'>导入媒体</a>
            </div>
            <div class='listMenuElementAdmin'>
