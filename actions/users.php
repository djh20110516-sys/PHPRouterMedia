    ...
    <?php
        ...
        ?>
            <tr>
                ...
                <td>
                    <input placeholder='新密码' type='password' name='passa' id='<?php echo $row[ 'username' ]; ?>_passa' 
                        class='<?php echo $row[ 'username' ]; ?>' />
                    <input placeholder='确认密码' type='password' name='passb' id='<?php echo $row[ 'username' ]; ?>_passb' 
                        class='<?php echo $row[ 'username' ]; ?>' />
                    <input type='button' class='userchangepass' id='userchangepass' value='修改' data-name='<?php echo $row[ 'username' ]; ?>' />
                </td>
                <td>
                    <input type='button' class='userdelete' id='userdelete' name='userdelete' value='删除' data-name='<?php echo $row[ 'username' ]; ?>' />
                </td>
                <td>
                    <?php 
                        if( $admin ){
                    ?>
                    <input type='button' class='usernoadmin' id='usernoadmin' name='usernoadmin' value='取消管理' data-name='<?php echo $row[ 'username' ]; ?>' />
                    <?php 
                        }else{
                    ?>
                    <input type='button' class='useradmin' id='useradmin' name='useradmin' value='设为管理' data-name='<?php echo $row[ 'username' ]; ?>' />
                    <?php 
                        }
                    ?>
                </td>
		...
		<tr>
			...
			<td>
                ...
                <input placeholder='用户名' type='input' id='username' name='username' />
            </td>
			<td>
                <input placeholder='密码' type='password' id='pass1' name='pass1' />
                <input placeholder='确认密码' type='password' id='pass2' name='pass2' />
			</td>
			
			<td>
                <input type="checkbox" name="useradmin" id="useradmin" value="1" />管理员
			</td>
			<td>
                <input type='submit' id='buseradd' value='添加' />
                </form>
			</td>
		</tr>
    </table>
