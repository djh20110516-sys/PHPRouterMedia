<?php
	...
	//MIN BITRATE HD
	define( 'O_VIDEO_HD_MINBRATE', '3M' );
	//MAX BITRATE HD
	define( 'O_VIDEO_HD_MAXBRATE', '8M' );
	//HEIGHT HD
	define( 'O_VIDEO_HD_HEIGHT', '1080' );
	...
	//ADD V4L2 HARDWARE ENCONDING (RK3528A/树莓派等ARM平台)
	//需要内核加载V4L2驱动模块才能使用
	define( 'O_VIDEO_V4L2_ENCODE', FALSE );
	define( 'O_VIDEO_V4L2_ENCODE_ADMIN', FALSE );
	...
	//Set your API keys in config.ws.php to override these defaults (config.ws.php is not tracked by git)
